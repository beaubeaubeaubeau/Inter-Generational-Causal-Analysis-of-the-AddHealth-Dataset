...
Re-runs the outcome-dependent part of the task14 diagnostic battery (D1 baseline WLS on `GSWGT4_2`, cluster-robust on `CLUSTER2`, primary spec L0+L1+AHPVT; D4 adjustment-set stability across L0 / L0+L1 / L0+L1+AHPVT) across 12 non-cognitive outcomes. Outcome-independent diagnostics (D2 height NC, D6/D7 dose-response + overlap, D8 saturation loss, D9 red flags) are inherited from [outputs/14_screening_matrix.csv](14_screening_matrix.csv).
