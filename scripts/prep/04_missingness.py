...
Outputs:
    scripts/prep/outputs/04_missingness_profile.csv
    scripts/prep/outputs/04_missingness_profile.md
"""
...
def main() -> None:
    ...
    lines.append("")
    lines.append(f"- CSV: `scripts/prep/outputs/04_missingness_profile.csv`")
