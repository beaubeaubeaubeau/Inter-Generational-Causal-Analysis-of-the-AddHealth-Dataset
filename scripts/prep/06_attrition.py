...
Outputs
-------
    scripts/prep/outputs/06_attrition_patterns.csv       -- AID-level long table of
        presence indicators and Wave I stratification variables.
    scripts/prep/outputs/06_attrition_stacked_bar.png    -- stacked bar chart of public-use
        appearances per wave, stacked by BIO_SEX.
    scripts/prep/outputs/06_attrition_summary.md         -- human-readable summary.
"""
...
def _read_aids(path: Path) -> set[str]:
    ...
    cached to ``cache/aids/<fname>.pkl``."""
