...
Output parquets:
  cache/analytic_w4.parquet  (W1 network + W1 inhome + W4 in-home + weights)
  cache/analytic_w5.parquet  (W1 network + W1 inhome + W5 cognitive + weights,
                              MODE-restricted to in-person + phone)
  cache/analytic_w1_full.parquet (W1 in-home + W1 weights only - for full-N
                              specs that do not require the network file)

Also writes a diagnostic N table to scripts/prep/outputs/08_analytic_frame_n.md that reconciles
...
# `analysis` package lives at scripts/analysis/, one level up from scripts/prep/.
sys.path.insert(0, str(HERE.parent))

from analysis import ROOT, CACHE  # noqa: E402
from analysis.cleaning import clean_var  # noqa: E402
from analysis.data_loading import (  # noqa: E402
