...
Outputs:
    outputs/03a_wave1_friendship_items.md
    outputs/03b_network_variable_catalog.csv
    outputs/03b_network_variable_catalog.md
    outputs/cache/w1inhome_meta.parquet
"""
