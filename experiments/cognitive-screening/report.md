...
<!-- TODO: prose around figures/primary/screening_heatmap.png, adjustment_stability.png,
     coefficient_forest.png, quintile_dose_response.png, partial_residual_IDGX2.png,
     composite_vs_components.png, heterogeneity_interactions.png, weighted_vs_unweighted.png. -->

## Diagnostics (D1–D9)

<!-- TODO: prose around figures/diagnostics/sibling_dissociation.png,
     component_consistency.png, negctrl_failure_grid.png; link to methods.md §2 for
     D1-D9 definitions. -->

## Sensitivity audits

<!-- TODO: prose around figures/sensitivity/ahpvt_with_without.png,
     saturated_vs_full.png, placebo_panel.png. -->

## Verification

<!-- TODO: prose around figures/verification/attrition_balance.png,
     mode_selection_balance.png; tables/verification/13_*.csv. -->
